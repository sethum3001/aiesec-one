  ...
  if (session != null) {
    ...
    return (
      <main className={styles.login}>
        <Card shadow="sm" padding="lg" radius="lg" withBorder className={styles.card} px={32}>
          ...
          <Group grow mb="sm" mt="lg">
            <GoogleButton radius="xl" size="md" onClick={login} disabled={isLoading}> <Text size="15" fw={600}>
              Sign in with Google
            </Text></GoogleButton>
          </Group>
        </Card>
